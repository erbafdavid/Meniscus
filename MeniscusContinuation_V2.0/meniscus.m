classdef meniscus
    ...
    properties
        ...
        alphaend            % same thing if typestart = 'angle'
    ...
    methods
        ...
        function m = meniscus(type,N,param)
            ...
            switch(type)
                ...
                m.N = N;
                R0 = param(1); % this is the radius of curvature
...
%                    m.RHS(m.N) =0;
        ...
        function plotmeniscus(m,numfig,plotstyle);
            ...
            if(ismember(numfig,m.whichfigures))
            figure(numfig);
