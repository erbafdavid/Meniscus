...
if(discretization=='FD')
    [eta,P1,RES,lambdaminV,lambdamaxV,lambdaminP,lambdamaxP,lambdamin1,lambdamax1] = calceta_V_FD(R,Z,P,alpha,ds,s0,Ka,Kb,dpdz,V);
else
    [eta,P1,RES,lambdaminV,lambdamaxV,lambdaminP,lambdamaxP,lambdamin1,lambdamax1] = calceta_V_FE(R,Z,P,alpha,ds,s0,Ka,Kb,dpdz,V);
end
