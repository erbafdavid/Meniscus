function [R,Z,P,V,conv,lambdaminV,lambdaminP,lambdamin1] = Newton_V(R0,Z0,P0,V0,newV)
...
figure(31);   
   ...
   if(discretization=='FD')
     ...
     plot(P,real(lambdaminP),'*r',P,real(lambdamaxP),'sr',  ...
          P,real(lambdaminV),'*b',P,real(lambdamaxV),'sb',  ...
          P,real(lambdamin1),'*g',P,real(lambdamax1),'sg'  )
   end
